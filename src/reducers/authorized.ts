...
export default function authorized(
    ...
    switch(action.type) {
        ...
        case LOGIN_SUCCESS:
            return {...state, isLogin: true, errorLogin: null, userData: action.data || action.data}
        case LOGIN_ERROR:
            return {...state, isLogin: false, errorLogin: action.error, errorRegister: null, userData: {} }
        case REGISTER_REQUEST:
            return {...state, isLogin: false}
        case REGISTER_SUCCESS:
            return {...state, isLogin: true, errorRegister: null, userData: action.data }
        case REGISTER_ERROR:
            return {...state, isLogin: false, errorLogin: null, errorRegister: action.error, userData: {} }
        case LOG_OUT: 
